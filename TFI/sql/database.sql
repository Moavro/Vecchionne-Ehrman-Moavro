...
insert into usuarios(id, email, usuario, clave, foto_perfil, fecha_nacimiento, dni) values(default, "tufobarra12@gmail.com", "tufobarra12", "1234", "/images/users/perfil.jfif", "2000-09-04","45487253");
insert into usuarios(id, email, usuario, clave, foto_perfil, fecha_nacimiento, dni) values(default, "tufito13@gmail.com", "tufito13", "2234", "/images/users/perfil.jfif", "2001-08-07","45487100");
insert into usuarios(id, email, usuario, clave, foto_perfil, fecha_nacimiento, dni) values(default, "tufarini14@gmail.com", "tufarini14", "3234", "/images/users/perfil.jfif", "2002-07-02","45487960");
insert into usuarios(id, email, usuario, clave, foto_perfil, fecha_nacimiento, dni) values(default, "tufan15@gmail.com", "tufan15", "4234", "/images/users/perfil.jfif", "2003-03-06","45487980");
insert into usuarios(id, email, usuario, clave, foto_perfil, fecha_nacimiento, dni) values(default, "tufarina16@gmail.com", "tufarina16", "5234", "/images/users/perfil.jfif", "2004-05-04","45487483");
...
insert into productos(id, usuario_id, nombre, descripcion, foto_producto, fecha_carga) values(default, 2, "Nike Vapor", "Domina el balon con estos botines Adidas de corte bajo","/images/products/timbos2.webp", "2020-01-01");
insert into productos(id, usuario_id, nombre, descripcion, foto_producto, fecha_carga) values(default, 3, "Adidas Predator Edge", "Domina el balon con estos botines Adidas sin cordones","/images/products/timbos3.webp", "2020-01-01");
insert into productos(id, usuario_id, nombre, descripcion, foto_producto, fecha_carga) values(default, 4, "Adidas Goleto VIII", "Botines para pasto sintetico hechos parcialmente con contenido reciclado","/images/products/timbos4.webp", "2020-01-01");
insert into productos(id, usuario_id, nombre, descripcion, foto_producto, fecha_carga) values(default, 5, "Adidas Speedportal", "Botines para terreno blando que te ayudan a controlar cada parte de tu juego","/images/products/timbos5.webp", "2020-01-01");
insert into productos(id, usuario_id, nombre, descripcion, foto_producto, fecha_carga) values(default, 4, "Adidas Nemeziz", "Controla cada jugada con estos botines Adidas","/images/products/timbos6.webp", "2020-01-01");
insert into productos(id, usuario_id, nombre, descripcion, foto_producto, fecha_carga) values(default, 3, "New Balance Furon", "Logra tu mejor jugada conn estos botines hechos en parte con materiales reciclados","/images/products/timbos7.webp", "2020-01-01");
insert into productos(id, usuario_id, nombre, descripcion, foto_producto, fecha_carga) values(default, 2, "New Balance Tekela", "Botines veloces inspirados en Messi hechos parcialmente con materiales reciclados","/images/products/timbos8.webp", "2020-01-01");
insert into productos(id, usuario_id, nombre, descripcion, foto_producto, fecha_carga) values(default, 1, "New Balance Furon V7", "Domina los partidos sobre terreno firme con estos botines lleno de colores","/images/products/timbos9.webp", "2020-01-01");
insert into productos(id, usuario_id, nombre, descripcion, foto_producto, fecha_carga) values(default, 5, "Adidas Copa Pure", "Mejora tu juego con los suaves botines sinteticos de Adidas x Classic Lego","/images/products/timbos10.webp", "2020-01-01");
